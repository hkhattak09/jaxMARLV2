...
class MAPPO(OnPolicyBase):
    ...
    def update(self, sample):
        ...
        actor_grad = torch.cat([p.grad.view(-1) for p in self.actor.parameters() if p.grad is not None], dim=0)
        ...
        return policy_loss, dist_entropy, actor_grad_norm, actor_grad, imp_weights
