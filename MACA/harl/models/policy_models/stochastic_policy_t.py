...
class StochasticPolicyTrans(StochasticPolicy):
    ...
    def forward(
        ...
        Returns:
            ...
            policy_probs: (torch.Tensor) policy distribution.
        """
        ...
        actions, action_log_probs, policy_probs = self.act(
            actor_features, available_actions, deterministic
        )

        return actions, action_log_probs, policy_probs, rnn_states
