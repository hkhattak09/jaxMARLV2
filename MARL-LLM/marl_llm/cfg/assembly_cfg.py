...
parser.add_argument("--d_sen", type=float, default=0.4, help='Agent sensing radius. Must be >= thinnest_feature_width/2 for the global medial axis signal to work. Default 0.4.')
