...
Defaults follow the MACA COMA paper hyperparameter tables, adapted for the
JAX/Flax SMAX training loop.
"""


def get_default_coma_config():
    """Return the default COMA configuration.
